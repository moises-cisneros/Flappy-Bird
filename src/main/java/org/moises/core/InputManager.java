...
public class InputManager {
     ...
     * @return {@code true} si la tecla pasó de no presionada a presionada en este
     *         frame.
     */
     ...
     *
     * @return la {@link MenuAction} detectada en este frame, o
     *         {@link MenuAction#NONE}.
     */
    public MenuAction getMenuAction() {
        if (isJustPressed(KEY_1))
        ...
        if (isJustPressed(KEY_UP))
            return MenuAction.NAV_UP;
        if (isJustPressed(KEY_DOWN))
            return MenuAction.NAV_DOWN;
